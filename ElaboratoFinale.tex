...
\subsection[Virtual Interface]{Virtual Interface\footnote{For implementation information, see \autoref{ssec:vcontr}}}
\label{ssec:vint}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{img/IMG_20160827_163033_1} 
\caption{Realised Robot.}
\end{figure}
