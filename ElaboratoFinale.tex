...
% @Fabio: ho scritto che il grafico con i periodi è sopra perchè nel mio documento di prova lo mette sopra questo paragrafo, però stai all'occhio che potrebbe cambiarlo a seconda di come è il resto scritto prima della parte sul test. Se ti senti più sicuro ci si può fare una \ref però visto che a me non compila gli \autoref lascerei fare a te :)
